	...
	for(var i = 0; i < inputs.length; i++) {
		if(inputs[i].className.indexOf('default') < 0) {
			...
			if((opt.clearInputs && inputType === 'text') ||
				...
				(opt.clearPasswords && inputType === 'email')
			) {
	...
	PlaceholderInput.prototype = {
		init: function(opt) {
			...
			if(this.element && this.element.PlaceholderInst) {
				...
				if(this.elementType == 'text' || this.elementType == 'password' || this.elementType == 'textarea' || this.elementType == 'email') {
					this.initElements();
					this.attachEvents();
					this.refreshClasses();
				}
		...
		attachEvents: function() {
			this.element.onkeydown = bindScope(this.focusHandler, this);
